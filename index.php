...
<head>
    ...
    <link rel="stylesheet" href="assets/select2-develop/dist/css/select2.min.css">
    <link rel="stylesheet" href="assets/select2-bootstrap4-theme-master/dist/select2-bootstrap4.min.css">
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top" role="navigation" style="margin-bottom: 0; background: #0000CD">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-bg text-tengah">
                    <a class="navbar-merek" href="index.php">Bengkel Agung Toyota Sipin Jambi Persediaan Suku Cadang Mobil</a>
                </div>
            </div>
    ...
    <div class="navbar navbar-inverse navbar-fixed-bottom footer-bottom" style="background-color:#0000CD;">
        <div class="container text-center">
            <p class="margin-left text-center" style="color: #D1C4E9;"><small>Copyright @ 2020 Bengkel Agung Toyota Sipin Jambi</p>
        </div>
        <!-- /. WRAPPER  -->
        ...
        <script src="assets/jQuery-Plugin-To-Print-Any-Part-Of-Your-Page-Print/dist/jQuery.print.min.js"></script>
</body>
